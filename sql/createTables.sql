...
CREATE TABLE BookRatings(bookCode int, userID int,userComment TEXT,genre CHAR(3),rating DOUBLE,subimtted DATE, CONSTRAINT user_exists FOREIGN KEY (userID) REFERENCES Users(userID));
