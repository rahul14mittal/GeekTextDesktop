...
CREATE TABLE BookRatings(bookCode int, userID int,userComment TEXT,rating DOUBLE,subimtted DATE, CONSTRAINT user_exists FOREIGN KEY (userID) REFERENCES Users(userID));
